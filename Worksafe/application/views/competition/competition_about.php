...
<table class="bordered">
    <thead>
		<tr>
			<th id="red">Team One - Red</th>
			<th id="blue">Team Two - Blue</th>
			<th id="orange">Team Three - Orange</th>
			<th id="yellow">Team Four - Yellow</th>
			<th id="green">Team Five - Green</th>
		</tr>
  </thead>
      <tbody>
      	<tr>
      		<td>Adkins, Heather</td>
      		<td>Craig, Jane</td>
      		<td>James, Brenda</td>
      		<td>Muenks, Dale</td>
      		<td>Sestak, Lynn</td>
      	...
      	<tr>
      		<td>Ahmed, Annie</td>
      		<td>Crampton, Julie</td>
      		<td>Jeffries, Ted</td>
      		<td>Murray, Kylie</td>
      		<td>Shahid, Muhammad</td>
      	</tr>
      	<tr>
      		<td>Ahrens, Chasitity</td>
      		<td>Crane, Toma</td>
      		<td>Jenkins, Amber</td>
      		<td>Nelson, Rick</td>
      		<td>Shoener, Ashley</td>
      	</tr>
      	<tr>
      		<td>Alam, Mohammed</td>
      		<td>Crane, Kent</td>
      		<td>Jennings, Sarah</td>
      		<td>Newsom, Linda</td>
      		<td>Sides Cooper, Laura</td>
      	</tr>
      	<tr>
      		<td>Ancell, Kim</td>
      		<td>Daugherty, Aaron</td>
      		<td>Johnson, Shirley</td>
      		<td>Norman, Bette</td>
      		<td>Sievers, Shann</td>
      	</tr>
      	<tr>
      		...
      		<td>Jones, Kenneth</td>
      		<td>North, Thomas</td>
      		<td>Sitaraman, Aarthi</td>
      	</tr> 
      	<tr>
      		<td>Andersen, Devon</td>
      		<td>Davis, Scott</td>
      		<td>Jones, Tina</td>
      		<td>Oney, Tom</td>
      		<td>Sites, Brad</td>
      	...
      	<tr>
      		<td>Annunziata, Scott</td>
      		<td>DelRosario, Rebecca</td>
      		<td>Kallenbach, Amy</td>
      		<td>Owen, James</td>
      		<td>Snellen, Micki</td>
      	</tr>
      	<tr>
