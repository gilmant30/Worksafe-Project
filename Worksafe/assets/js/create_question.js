...
$(function(){
  $(document).on('click', '#add_multi_choice_answer', function() {
   $('<input type="text" id="answer" size="40" name="answer'+a+'" value="" placeholder="Answer" required/><input type="radio" id="correct_ans" name="radio_answer" value="correct_ans'+a+'"/><label>Correct answer</label>').appendTo($('#add_answer'));
...
$(function(){
  $(document).on('click', '#add_multi_select_answer', function() {
   $('<input type="text" id="answer'+ a +'" size="40" name="answer" value="" placeholder="Answer" required/><input type="checkbox" id="correct_ans" name="checkbox_answer" value="correct_ans'+a+'"/><label>Correct answer</label>').appendTo($('#add_answer'));
...
function displayMultipleSelect(){
  $('div#add_answer').replaceWith('<div id="add_answer"><br /><a href="" id="add_multi_select_answer">Add answer field</a><br /></div>');
}
